          ...
          drawerItem(
              ...
              callBack: () {
                Navigator.of(context)
                    .push(CustomPageRoute(child: MyAppointmentsScreen()));
                // ApiHelper().getMyAppoinments();
              }),
          divider(size),
          drawerItem(
              size: size,
              ...
              callBack: () {
                Navigator.of(context)
                    .push(CustomPageRoute(child: ChatRoomScreen()));
              }),
          divider(size),
          drawerItem(
              size: size,
        ...
        child: Column(
          ...
          children: [
            CircleAvatar(
              ...
              foregroundImage: UserManager.user.profileImage != null
                  ? NetworkImage(UserManager.user.profileImage!)
                  : AssetImage('assets/no_profile-pic.jpg') as ImageProvider,
            ),
            SizedBox(
