...
class UrologistsScreen extends StatefulWidget {
  @override
  State<UrologistsScreen> createState() => _UrologistsScreenState();
}

class _UrologistsScreenState extends State<UrologistsScreen> {
  ...
  @override
  void initState() {
    _boc.add(GetDoctorsSpecialityEvent(FirebaseStrings.urologist));
    repo.getAllCardioDoctors(FirebaseStrings.urologist);
