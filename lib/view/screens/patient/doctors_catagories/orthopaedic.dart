...
class OrthopadicScreen extends StatefulWidget {
  @override
  State<OrthopadicScreen> createState() => _OrthopadicScreenState();
}

class _OrthopadicScreenState extends State<OrthopadicScreen> {
  ...
  @override
  void initState() {
    _boc.add(GetDoctorsSpecialityEvent(FirebaseStrings.orthopaedic));
    repo.getAllCardioDoctors(FirebaseStrings.orthopaedic);
