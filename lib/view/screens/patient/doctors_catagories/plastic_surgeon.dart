...
class PlasticSurgeonScreen extends StatefulWidget {
  @override
  State<PlasticSurgeonScreen> createState() => _PlasticSurgeonScreenState();
}

class _PlasticSurgeonScreenState extends State<PlasticSurgeonScreen> {
  ...
  @override
  void initState() {
    _boc.add(GetDoctorsSpecialityEvent(FirebaseStrings.plasticSurgeons));
    repo.getAllCardioDoctors(FirebaseStrings.plasticSurgeons);
