...
class RadiologistsScreen extends StatefulWidget {
  @override
  State<RadiologistsScreen> createState() => _RadiologistsScreenState();
}

class _RadiologistsScreenState extends State<RadiologistsScreen> {
  ...
  @override
  void initState() {
    _boc.add(GetDoctorsSpecialityEvent(FirebaseStrings.radiologist));
    repo.getAllCardioDoctors(FirebaseStrings.radiologist);
