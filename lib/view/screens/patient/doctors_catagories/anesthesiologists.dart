...
class AnesthesiologistsScreen extends StatefulWidget {
  @override
  State<AnesthesiologistsScreen> createState() =>
      _AnesthesiologistsScreenState();
}

class _AnesthesiologistsScreenState extends State<AnesthesiologistsScreen> {
  ...
  @override
  void initState() {
    _boc.add(GetDoctorsSpecialityEvent(FirebaseStrings.anesthesiologists));
    repo.getAllCardioDoctors(FirebaseStrings.anesthesiologists);
