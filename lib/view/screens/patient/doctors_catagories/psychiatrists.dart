...
class PsychiatristsScreen extends StatefulWidget {
  @override
  State<PsychiatristsScreen> createState() => _PsychiatristsScreenState();
}

class _PsychiatristsScreenState extends State<PsychiatristsScreen> {
  ...
  @override
  void initState() {
    _boc.add(GetDoctorsSpecialityEvent(FirebaseStrings.psychiatrists));
    repo.getAllCardioDoctors(FirebaseStrings.psychiatrists);
