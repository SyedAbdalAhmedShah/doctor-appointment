...
class OthersDoctorScreen extends StatefulWidget {
  @override
  State<OthersDoctorScreen> createState() => _OthersDoctorScreenState();
}

class _OthersDoctorScreenState extends State<OthersDoctorScreen> {
  ...
  @override
  void initState() {
    _boc.add(GetDoctorsSpecialityEvent(FirebaseStrings.others));
    repo.getAllCardioDoctors(FirebaseStrings.others);
